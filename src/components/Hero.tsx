    ...
    <div className="lg:mt-8 ">
      <section className=" flex flex-col items-center lg:justify-between lg:flex-row gap-y-10 py-6 px-6 ">
        ...
        <div className=" mt-8  lg:mt-16 flex-1 ">
          ...
          <div className="mt-8 flex flex-col   md:flex-row lg:flex-row  md:space-x-4 lg:space-x-8">
            <a
              className="flex px-2 mb-2 h-16 text-xl font-bold w-full text-white md:w-40 lg:w-40 rounded-full bg-blue-600 hover:bg-white hover:duration-700  hover:text-blue-600 justify-center items-center cursor-pointer"
              href={"/"}
            >
              Explore
            </a>
            <a
              className="flex px-2 h-16 text-xl font-bold border-2 w-full md:w-40 border-white text-white hover:bg-purple-600 hover:duration-700 lg:w-40 rounded-full justify-center items-center cursor-pointer"
              href={"/"}
            >
              Create
            </a>
          </div>
          <div className="flex space-x-4 md:space-x-8  lg:space-x-8 mt-16 items-center lg:justify-start justify-center">
